...
/// through its `SceneNodeRef`. Injected into systems as an `@Resource()`.
///
/// `SceneNodeRef` is entity → node; this is the other direction, which you need
...
final class SceneNodeIndex {
  ...
  /// no ancestor is a bound `SceneNodeRef` node.
